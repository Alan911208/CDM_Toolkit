...
export default function render() {
  return `<div class="page-section"><h2>📊 SAS 批量转 Excel</h2><p class="section-subtitle">拖拽 .sas7bdat 数据集 → 批量转换为 Excel，表头格式：第一行变量名，第二行label</p></div>
...
export async function init() {
  ...
  btn.addEventListener('click', async () => {
    ...
    try {
      ...
      resultDiv.innerHTML = '<p style="color:#2E7D32;">✅ 转换完成 — 第一行变量名，第二行label</p>';
      showToast('批量转换完成');
